...
def print_and_save(data, out_jsonl=None):
    ...
    print(f"  nester_ip: {data.get('nester_ip')}")
    print(f"  harvester_ip: {data.get('harvester_ip')}")
...
if __name__ == "__main__":
    ...
    p.add_argument("--host", default="10.251.7.129", help="IP/hostname du server (nester)")
    ...
    p.add_argument("--out-jsonl", default='mesures.jsonl', help="fichier JSONL pour append des mesures")
    args = p.parse_args()
